    ...
    <div className="min-h-screen font-sans">
      ...
      <Card className="w-full max-w-md mx-auto bg-white shadow-lg border-none rounded-none">
        <CardHeader className="text-center p-4">
          <CardTitle className="text-2xl font-bold text-green-800">Charlotte Photoshoot</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="relative rounded-xl overflow-hidden">
            ...
            <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-end p-4 text-white">
              <h2 className="text-xl font-bold">Professional Photography in Charlotte</h2>
          ...
          <Card className="bg-blue-50 border-blue-200">
            <CardContent className="p-4">
              ...
              <p className="text-sm text-blue-700">
                With 3+ years of professional experience, Aidan brings expertise and vision to every shoot in beautiful Charlotte, NC.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-green-50 border-green-200">
            <CardContent className="p-4">
              ...
              <ul className="list-disc list-inside text-sm text-green-700 space-y-1">
                ...
                <li>Photo delivery within 2 weeks</li>
              </ul>
            </CardContent>
          </Card>
      ...
      <Dialog open={showConfirmation} onOpenChange={setShowConfirmation}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Thank you for your interest in a Charlotte photoshoot with Aidan. We've received your request and will get back to you soon to confirm the details.
            </DialogDescription>
          </DialogHeader>
